...
class bldg:
    ...
    def __init__(self, ui, chat):
        ...
        self.owner = ResponseSchema(name="owner", description="Building Owner Description. Include their name, race, and a brief description of their personality/appearance. (1-2 Sentences)")
        self.goods = ResponseSchema(name="goods", description="Description of the goods sold in the building. (1-2 Sentences)")
        self.response_schema = [self.type, self.name, self.architecture, self.ambience, self.size, self.traffic, self.description, self.owner, self.goods]
